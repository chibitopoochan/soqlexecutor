 ...
 */
public class PartnerDescribeGlobalSObjectResultWrapper implements DescribeGlobalSObjectResultWrapper {
	private DescribeGlobalSObjectResult result;

	/**
	 * ラップ対象を持たせずにインスタンス化
	 */
	public PartnerDescribeGlobalSObjectResultWrapper() {}

	/**
	 * {@link com.sforce.soap.partner.DescribeGlobalSObjectResult}をラップ
	 * @param result ラップ対象
	 */
	public PartnerDescribeGlobalSObjectResultWrapper(DescribeGlobalSObjectResult result) {
