 ...
 */
public class PartnerLoginResultWrapper implements LoginResultWrapper {
	private LoginResult result;

	/**
	 * ラップ対象を持たせずにインスタンス化
	 */
	public PartnerLoginResultWrapper(){}

	/**
	 * {@link com.sforce.soap.partner.LoginResult}をラップ
	 * @param result ラップ対象
	 */
	public PartnerLoginResultWrapper(LoginResult result) {
